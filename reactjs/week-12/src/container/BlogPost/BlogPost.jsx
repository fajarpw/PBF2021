    ...
    render() {
        return (
            <div className="container-fluid">
                ...
                <div className="row">
                    <div className="col">
                        <div className="form-group row" style={{ marginTop: "10px" }}>
                            ...
                            <div className="col-sm-10">
                                <textarea name="body" id="body" rows="3" ref="isiArtikel" style={{minWidth:"100%"}}></textarea>
                            </div>
                ...
                <div className="row">
                    <div className="col">
                        <button type="submit" className="btn btn-primary" onClick={this.handleTombolSimpan} size="lg" block>Simpan</button>
                    </div>
                </div>
